...
public class SingleLocationStrategyTest {
    ...
    public void initSingleLocationStrategyTest(){
        ...
        when(stockInterfaceRepository.findByLocationId(location.getId())).thenReturn(mockStock);
    }
    ...
    public void successRunningStrategy(){
        ...
        List<Stock> stocks = singleLocationStrategy.findBestLocation(orderDetails);
